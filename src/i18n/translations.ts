...
const en: Dictionary = {
  ...
  cloudAccount: 'Account & Cloud Backup',
  cloudAccountDesc: 'Sign in to back up your data to the cloud automatically.',
  cloudAccountSignUpDesc: 'Create a free account to back up your data to the cloud automatically.',
  ...
  signOut: 'Sign Out',
  signOutConfirm: 'Sign out? Your data stays on this device, but automatic cloud backups will stop.',
  signedInAs: 'Signed in as',
  cloudAutoBackupDesc: 'Your changes are backed up to the cloud automatically.',
  lastCloudBackup: 'Last cloud backup',
  noCloudBackupYet: 'No cloud backup yet',
  ...
  cloudRestoreSuccess: 'Cloud backup restored to this device.',
  cloudBackupSuccess: 'Cloud backup completed.',
  cloudSyncing: 'Backing up…',
  cloudSyncError: 'Last automatic backup failed',
...
const it: Dictionary = {
  ...
  cloudAccount: 'Account e backup cloud',
  cloudAccountDesc: 'Accedi per salvare automaticamente i tuoi dati nel cloud.',
  cloudAccountSignUpDesc: 'Crea un account gratuito per salvare automaticamente i tuoi dati nel cloud.',
  ...
  signOut: 'Esci',
  signOutConfirm: 'Uscire? I dati restano su questo dispositivo, ma i backup cloud automatici si interrompono.',
  signedInAs: 'Accesso effettuato come',
  cloudAutoBackupDesc: 'Le tue modifiche vengono salvate automaticamente nel cloud.',
  lastCloudBackup: 'Ultimo backup cloud',
  noCloudBackupYet: 'Nessun backup cloud',
  cloudBackupNow: 'Esegui backup ora',
  cloudRestore: 'Ripristina dal cloud',
  ...
  cloudRestoreSuccess: 'Backup cloud ripristinato su questo dispositivo.',
  cloudBackupSuccess: 'Backup cloud completato.',
  cloudSyncing: 'Backup in corso…',
  cloudSyncError: 'Ultimo backup automatico non riuscito',
